...
def main():
    ...
    local_label = 'selection-mcp-reviewed' if args.with_mcp else 'selection-git-reviewed' if args.with_git else 'selection-verified'
    ...
    if args.with_git:
        git_label = 'git-mcp-reviewed' if args.with_mcp else 'git-verified'
    ...
    def native_records():
        ...
        for name in native:
            ...
            runner = 'run_native_plugin_mcp.py' if '-mcp-final-' in name else 'run_native_plugin_git.py' if Path(name).name.startswith(('codex-git-', 'copilot-git-')) else 'run_native_plugin_selections.py'
