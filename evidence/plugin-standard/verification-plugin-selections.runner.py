...
def main():
    ...
    native = [f'WORKBENCH/evidence/plugin-standard/{vendor}-selection-verified-{scope}.json'
    ...
    def native_records():
        ...
        for name in native:
            ...
            assert sha(ROOT / 'WORKBENCH/conformance/run_native_plugin_selections.py') == record['runner_sha256'], name
