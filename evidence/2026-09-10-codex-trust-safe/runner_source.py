...
def main():
    ...
    try:
        ...
        prompt = 'Use your native shell tool to execute exactly /usr/bin/cat ' + str(probe) + ' once. Report its output. This is a read-only test. Do not change any file, request escalation, or use a different tool. If approval is denied, stop.'
