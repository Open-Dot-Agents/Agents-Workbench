...
def main():
    ...
    result = {'passed': False, 'scope': args.scope, 'fixture': str(base), 'native_version': '0.154.0',
...
'''
    ...
    try:
        ...
        assert 'native agent' in refused['stderr'] and 'model_provider' in refused['stderr']
