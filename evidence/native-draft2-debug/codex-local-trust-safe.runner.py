...
def main():
    ...
    parser.add_argument('--scenario', choices=['discovery', 'agent-execution', 'trust-safe', 'trust-rule-allow', 'trust-rule-deny'], default='discovery')
    ...
    if trust_case:
        ...
        if args.scenario == 'trust-safe':
            ...
            result['scenario_passed'] = result['scenario_passed'] and result['safe_command_without_approval']
        else:
