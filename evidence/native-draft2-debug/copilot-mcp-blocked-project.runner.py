...
def main():
 ...
 parser.add_argument('--scenario',choices=['call','blocked','expansion'],default='call')
 ...
 repo=Path(__file__).resolve().parents[2];root=Path(tempfile.mkdtemp(prefix='oda-native-mcp-',dir='/mnt/DATA/tmp'))
