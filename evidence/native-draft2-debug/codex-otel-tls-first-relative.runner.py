...
def certificate(directory, name, issuer=None, server=False):
...
def main():
    ...
    class Collector(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            exports.append({'path': self.path, 'body': body, 'client_serial': peer.serial_number})
            self.send_response(200)
    ...
    def run_native(home, label):
        ...
        assert all(e['client_serial'] == client_cert.serial_number for e in phase['exports']), 'wrong client certificate'
