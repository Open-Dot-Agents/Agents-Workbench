...
def main():
 ...
 p.add_argument('--trust',choices=['unreviewed','bypass'],default='bypass');p.add_argument('--scenario',choices=['execution','deny','timeout','disabled-field'],default='execution')
 ...
 try:
  ...
  result['initialize']=client.response(client.request('initialize',{'clientInfo':{'name':'oda-hooks','version':'0.1.0'}}),deadline);client.send({'method':'initialized','params':{}})
