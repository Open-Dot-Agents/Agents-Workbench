...
def terminal(binary, workspace, env, prompt, requests, result):
    ...
    try:
        ...
        # Escape rejects or cancels an open native approval dialog. Never send
        # Enter or an allow shortcut after the model has issued the tool call.
        child.send('\x1b')
        phase['phases']['cancel'] = read(3)
...
def main():
    ...
    try:
        ...
        if args.interface == 'acp':
            ...
            terminal(binary, workspace, env, prompt_text, requests, result)
